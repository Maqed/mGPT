...
function PromptInputPrimitive({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <InputGroup
      className={cn("max-h-60 has-data-[align=block-end]:rounded-b-none", className)}
      {...props}
    />
  );
}

function PromptInputTextareaPrimitive({ ...props }: React.ComponentProps<"textarea">) {
  return <InputGroupTextarea placeholder="Type your message here..." {...props} />;
}

function PromptInputFooterPrimitive({
  ...props
}: Omit<React.ComponentProps<typeof InputGroupAddon>, "align">) {
  return <InputGroupAddon align="block-end" className="rounded-none" {...props} />;
}
  ...
  const inner = (
    <>
      ...
      <form onSubmit={handleSubmit} ref={formRef} {...props}>
        <PromptInputPrimitive className={className}>{children}</PromptInputPrimitive>
      </form>
    </>
  );
...
export type PromptInputTextareaProps = ComponentProps<typeof PromptInputTextareaPrimitive>;
...
export const PromptInputFooter = ({ className, ...props }: PromptInputFooterProps) => (
  <PromptInputFooterPrimitive className={cn("justify-between gap-1", className)} {...props} />
);
