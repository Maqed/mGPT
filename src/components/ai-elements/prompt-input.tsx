...
function PromptInputTextareaPrimitive({
  ...props
}: React.ComponentProps<"textarea">) {
  return (
    <InputGroupTextarea placeholder="Type your message here..." {...props} />
  );
}
...
function PromptInputFooterPrimitive({
  ...
  return (
    <InputGroupAddon align="block-end" className="rounded-none" {...props} />
  );
}
  ...
  const inner = (
    <>
      ...
      <form onSubmit={handleSubmit} ref={formRef} {...props}>
        <PromptInputPrimitive className={className}>
          {children}
        </PromptInputPrimitive>
      </form>
    </>
  );
...
export type PromptInputTextareaProps = ComponentProps<
  typeof PromptInputTextareaPrimitive
>;
